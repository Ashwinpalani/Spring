...
export class AuthService {
  ...
  private baseUrl6="http://localhost:8080/tax/auth";
...
loginAuthentication(email:string,password:string): Observable<any>{
  return this.http.get<any>(`${this.baseUrl6}/${email}/${password}`);
} 
